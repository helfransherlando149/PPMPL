...
describe('Service Integration Tests with Multiple Stubs', () => {
    ...
    it('should return item from secondary repository if not found in primary', () => {
        // Arrange
        primaryRepositoryStub.getItemById.withArgs(2).returns(null);
    ...
    it('should delete item from primary repository if it exists', () => {
        // Arrange
        primaryRepositoryStub.deleteItemById.withArgs(5).returns(true);
    ...
    it('should delete item from secondary repository if not found in primary', () => {
        // Arrange
        primaryRepositoryStub.deleteItemById.withArgs(4).returns(false);
        secondaryRepositoryStub.deleteItemById.withArgs(4).returns(true);
        ...
        expect(secondaryRepositoryStub.deleteItemById.calledOnceWith(4)).to.be.true;
    });
...
describe('Service Integration Tests', () => {
    ...
    it('should throw an error when item is not found', () => {
        ...
        expect(() => service.getItemById(5)).to.throw('Item not found');
        expect(primaryRepositoryStub.getItemById.calledOnceWith(5)).to.be.true;
    });
